<template>
    <form method="post" @submit.prevent="submit">
        <div class="form-group is-invalid">
            ...
            <input type="file" class="form-control" :class="{ 'is-invalid': validation.slider_image}" ref="slider_image"
                   @change="addSliderImage" id="image" placeholder="Attach image">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" :class="{ 'is-invalid': validation.title}" v-model="form.title"
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" :class="{ 'is-invalid': validation.sub_title}"
                   v-model="form.sub_title" placeholder="Enter sub title ...">
        ...
        <div class="form-group">
            ...
            <input type="url" class="form-control" :class="{ 'is-invalid': validation.url}" v-model="form.url"
