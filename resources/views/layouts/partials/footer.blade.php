    ...
    <div class="s-footer__main">
        <div class="row">
            ...
            <div class="col-six tab-full s-footer__about">
                ...
                <h4>About Builders & Co creators</h4>
        ...
        <div class="row">
            ...
            <div class="col-six">
                <ul class="footer-social">
                    <li>
                        <a href="https://www.facebook.com/groups/1032120573544777/" target="_blank"><i class="fab fa-facebook"></i></a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="https://www.youtube.com/channel/UCu0EzYOmTbClSTaxLZQyGXg" target="_blank"><i class="fab fa-youtube"></i></a>
                    </li>
                </ul>
            </div>
            ...
            <div class="col-six">
                <div class="s-footer__copyright">
                    <span> &copy; @php echo date('Y') @endphp All rights reserved
                    </span>
                </div>
            </div>
